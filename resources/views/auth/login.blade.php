        ...
        <div class=" d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-12">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <h2 class="display-5 d-inline mr-2">Login</h2>
                    <span class="lead">to access our forums</span>
                    ...
                    <div class="form-group floating-label-form-group controls">
                        ...
                        <input type="password" class="form-control @error('username') is-invalid @enderror" id='password' name="password" placeholder="Password">
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group mt-5">
                        ...
                        <a href="{{route('register')}}" class="btn text-white btn-block bg-dark">Register instead</a>
                    </div>
                </form>
            </div>
            {{-- <div class="card">
